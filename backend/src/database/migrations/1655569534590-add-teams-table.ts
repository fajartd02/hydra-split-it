...
export class addTeamsTable1655569534590 implements MigrationInterface {
    name = 'addTeamsTable1655569534590'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "teams_users" ("team_id" integer NOT NULL, "user_id" integer NOT NULL, "collab_money" integer NOT NULL, "created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), "deleted_at" TIMESTAMP, CONSTRAINT "PK_7ef73da7c71c3028ec52cd3681d" PRIMARY KEY ("team_id", "user_id"))`);
